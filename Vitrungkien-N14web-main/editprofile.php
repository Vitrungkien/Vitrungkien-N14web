    ...
    <div class="">
        ...
        <table class="tblone">
            ...
            <tr>
                <td>Name</td>
                <td>:</td>
                <td><input type="text" class="profile" width="50px" name="name" value="<?php echo $result['name']?>"></td>
            </tr>
            <tr>
                <td>Email</td>
                <td>:</td>
            ...
            <tr>
                <td>Address</td>
                <td>:</td>
                <td><input class="profile" type="text" width="50px" name="address" value="<?php echo $result['address']?>"></td>
            </tr>
            <tr>
                <td>Phone</td>
                <td>:</td>
                <td><input class="profile" type="text" width="50px" name="phone" value="<?php echo $result['phone']?>"></td>
            </tr>
            <tr>
