...
<?php
    class product
    {
        ...
        public function get_product_by_brand(){
			$query = "SELECT * FROM tbl_product WHERE brandId='4' order by productId desc LIMIT 12";
			$result = $this->db->select($query);
			return $result;
		}

        public function get_product_by_brand_lenovo(){
            $query = "SELECT * FROM tbl_product WHERE brandId='1' order by productId desc LIMIT 4";
			$result = $this->db->select($query);
			return $result;
        }

        public function get_product_by_brand_msi(){
